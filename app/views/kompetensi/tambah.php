...
<div class="row">
    <div class="col-xs-10">
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= BASEURL; ?>kompetensi/tambah_data/" method="POST">
                <div class="form-group row">
                    <label for="kode" class="col-sm-2 col-form-label">Kode Kompetensi</label>
                    <div class="col-sm-3">
                         <input type="number" class="form-control" id="kode" name="kode" placeholder="Kode Kompetensi" min="4" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="kompetensi" class="col-sm-2 col-form-label">Kompetensi Keahlian</label>
                    <div class="col-sm-6">
                         <input type="text" class="form-control" id="kompetensi" name="kompetensi" placeholder="Kompetensi Keahlian" required>
                    </div>
                </div>
