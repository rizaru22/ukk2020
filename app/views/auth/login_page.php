...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <h3 class="login-box-msg">LOGIN MASYARAKAT</h3>

    <form action="<?= BASEURL; ?>auth/cek_login" method="post">
    ...
    <a href="<?= BASEURL; ?>auth/registrasi/" class="text-center">Registrasi Masyarakat</a>
